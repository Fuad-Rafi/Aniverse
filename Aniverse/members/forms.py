...
class EditProfileForm(UserChangeForm):
    ...
    class Meta:
        model=User
        fields=("username", "first_name", "last_name", "email", "last_login", "is_active","password" ,"date_joined")

    def __init__(self, *args, **kwargs):
        super(EditProfileForm, self).__init__(*args, **kwargs)
        self.fields['profile_pic'].label = "Profile Picture"
        self.fields['profile_pic'].help_text = "Upload a new profile picture (optional)"