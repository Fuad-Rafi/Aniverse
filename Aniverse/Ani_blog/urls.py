...
# from . import views 
from .views import Homeview, postDetailview, postAddview, postUpdateview, postDeleteview, categoryAddview, CategoryView, CategoryListView, LikeView, SearchView, add_comment
